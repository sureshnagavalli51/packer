...
const (
	...
	buildProvisionnerLabel = "provision"
...
var buildSchema = &hcl.BodySchema{
	Blocks: []hcl.BlockHeaderSchema{
		...
		{Type: buildProvisionnerLabel, LabelNames: []string{"type"}},
		{Type: buildPostProcessLabel, LabelNames: []string{"type"}},
	},
}
