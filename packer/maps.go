...
func (mopp MapOfPostProcessor) Has(provisioner string) bool {
	_, res := mopp[provisioner]
	return res
}

func (mopp MapOfPostProcessor) Start(provisioner string) (PostProcessor, error) {
